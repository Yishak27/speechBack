...
class DataLoader:
    ...
    def get_file_path(self):
        ...
        print('file get path -------------------- ',self.data_dir)
    ...
    def load_audios(self, mono: bool, no_of_audios: int = 100) -> tuple:
        ...
        try:
            ...
            max_duration = 0
            dir_paths = 'train\\wav\\'
            for i, file in enumerate(os.listdir(self.data_dir + dir_paths)):
                if i > no_of_audios:
                    break
    ...
    def get_wav_files(self) -> list:
        ...
        try:
            ...
            path = path + '*.wav'
            wav_files = glob(path)
            print('Successfully got wav files')
            return wav_files
        except Exception as e:
            print('Failed to get wav files')
            print(e)
            sys.exit(1)
    ...
    def load_transcription(self, file_path: str, type, dest_path: str = '', save=False) -> dict:
        ...
        try:
            ...
            # self.train_audio_paths = audio_path
            # self.train_durations = duration
            print('Successfully loaded transcription data')
            print(
    ...
    def generate_meta_data(self, path, dest_path):
        ...
        try:
            print('Generating meta data csv')
            ...
            print('Successfully generated meta data csv')
        except Exception as e:
            print('Failed to generate meta data csv')
            print(e)
            sys.exit(1)
